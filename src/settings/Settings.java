...
public class Settings {
	...
	public static String AMAZON_MARKETPLACE = "CA";
	...
	public static int SCRAPE_MODE_SCRAPE_TOP_PRODUCTS_IN_BEST_SELLERS_CATEGORIES = 4;
		...
		public static int PAGES_TO_SCRAPE_IN_BEST_SELLERS_CATEGORIES = 2;
	...
	public static boolean DB_SET_PRODUCT_INACTIVE = true;
	
	public static boolean TEST_NO_DELAY = true;
	public static int TEST_MAX_ITEM_TO_SCRAPE = 5;
}
